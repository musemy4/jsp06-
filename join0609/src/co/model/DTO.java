...
public class DTO {
	...
	//생성자 입력할때
	public DTO(String id, String pw, String name, String code1, String code2, String phone, String email,
			String address) {
		super();
		this.id = id;
		this.pw = pw;
	...
	public String toString() {
		return "Dto [id=" + id + ", pw=" + pw + ", name=" + name + ", code1=" + code1 + ", code2=" + code2
